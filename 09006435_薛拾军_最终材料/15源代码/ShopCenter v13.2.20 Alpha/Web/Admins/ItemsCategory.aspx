<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemsCategory.aspx.cs"  MaintainScrollPositionOnPostback="true" Inherits="Admins_ItemsCategory" %>

<%@ Register src="../UserControl/itemCategory.ascx" tagname="itemCategory" tagprefix="uc1" %>
            ...
            <div id="sidebar-wrapper">
              ...
              <ul id="main-nav">
                ...
                <li> <a href="#"  class="nav-top-item current"  title="商品种类管理"> 商品分类管理 </a>
                  <ul>
                    <li><a  class="current"  href="ItemsCategory.aspx">一级分类</a></li>
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
        ...
        <ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">新增</a></li> 
        </ul>
        <div class="clear"></div>
      </div>
      ...
      <div class="content-box-content">  
            ...
            <p>
              <label>分类名：</label>
              <asp:TextBox ID="txtCName" runat="server" CssClass="text-input small-input" ></asp:TextBox> 
              <br />
            ...
            <p> 
              <asp:LinkButton ID="lbtnAdd"  CssClass="button" runat="server" 
                    onclick="lbtnAdd_Click">提交</asp:LinkButton>
            </p>
            </fieldset>
      ...
      <div class="content-box-header">
        <h3>修改分类</h3>
        <ul class="content-box-tabs">
          <li><a href="#tab2" class="default-tab">修改</a></li> 
        </ul>
        <div class="clear"></div>
      </div>
      <!-- End .content-box-header -->
      <div class="content-box-content">   
            ...
            <uc1:itemCategory ID="itemCategory2" runat="server" />
            <div class="clear"></div>
            <!-- End .clear -->
        </div>  
      </div>
