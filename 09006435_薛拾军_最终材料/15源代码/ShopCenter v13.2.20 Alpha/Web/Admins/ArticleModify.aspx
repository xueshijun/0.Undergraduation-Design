<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArticleModify.aspx.cs" Inherits="Admins_ArticleModify" %>
   
<%@ Register src="../kindEditor/ArticleList.ascx" tagname="ArticleList" tagprefix="uc1" %> 
              ...
              <ul id="main-nav">
                ...
                <li> <a href="#" class="nav-top-item current" > 文章管理 </a>
                  <ul> 
                    ...
                    <li><a  class="current" href="ArticleModify.aspx">文章管理</a></li>
    ...
    <div class="content-box">
      ...
      <div class="content-box-header">
        ...
        <ul class="content-box-tabs">
          <li><a href="#tab1" class="default-tab">修改文章</a></li>
      ...
      <div class="content-box-content">
        ...
        <iframe src="ArticleAddForm.aspx" frameborder="0" scrolling="no"  style="height: 850px; width:100%;"></iframe>
