<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ItemsImgModify.aspx.cs" Inherits="Admins_ItemsImgModify" %>
 

<%@ Register src="../UserControl/itemImages.ascx" tagname="itemImages" tagprefix="uc1" %>
 

<%@ Register src="../UserControl/itemImgChaItemID.ascx" tagname="itemImgChaItemID" tagprefix="uc2" %>
 

<%@ Register src="AdminUserControl/adminMenu.ascx" tagname="adminMenu" tagprefix="uc3" %>
            ...
            <div id="sidebar-wrapper">
              ...
              <ul id="main-nav">
                ...
                <li> 
                    ...
                    <li><a class="current" href="ItemsImgModify.aspx">商品配图</a></li>
                  </ul>
                </li>
      ...
      <div class="content-box-content">
        <div class="tab-content default-tab" id="tab1">
          ...
          <table>
            ...
            <tbody>
              <tr>
              <td colspan="6" style=" margin-left:-100px;">
                <iframe src="ItemsImageForm.aspx" frameborder="0" scrolling="no"  style="height: 850px; width:100%;"></iframe>
              </td>
              </tr>
            </tbody>
          </table>
        ...
        <!-- End #tab1 -->
                <div class="tab-content" id="tab2">  
                    <uc2:itemImgChaItemID ID="itemImgChaItemID1" runat="server" />
          </div>
        <!-- End #tab2 --> 
      </div>
