<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Girl.aspx.cs" Inherits="Girl" MaintainScrollPositionOnPostback="true" %>
    ...
    <div class="pagepart">
	    <div class="partc1">
		    <div class="partc1_l left"> 
		         <div class="seain">
				    <h2>
                        <asp:LinkButton ID="lbtnAll" runat="server" onclick="lbtnAll_Click">女装分类</asp:LinkButton></h2>
				    <ul>
