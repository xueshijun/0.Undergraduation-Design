...
//		}		
		...
		Log.i("MAINACTIVITY","===================================商品编号为3的浏览GPS====================================");
		List<EntityLogView> list_EntityLogViews = ModelLogView.getLogViewByItemID(3);
		for(EntityLogView logView:list_EntityLogViews){
			logView.printEntityLogView();
		}	
		
//		Log.i("MAINACTIVITY","===================================商品编号为3的前十个浏览GPS====================================");
//		List<EntityLogView> list_EntityLogView = ModelLogView.getLastTenLogViewByItemID(3);
//		for(EntityLogView logView:list_EntityLogView){
//			logView.printEntityLogView();
//		}	
//		
