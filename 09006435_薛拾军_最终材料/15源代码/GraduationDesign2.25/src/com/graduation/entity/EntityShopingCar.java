...
public class EntityShopingCar {
	...
	public final static String ISPAY="IsPay";
	public final static String VISIABLE="Visible";
	public final static String PRODUCTID="ProductID";
	public final static String BRANDID="BrandID";
	public final static String ITEM_NAME="Name";
	public final static String PRICE_AGORANCE="AgoraPrice";
	public final static String PRICE_MENMBER="MemberPrice";
	public final static String PRICE_VIP="VipPrice";
	public final static String PRICE_SECKILL="SeckillPrice";
	public final static String AREA="Area";
	public final static String DETAILS="Details";
	public final static String VIEW_TIMES="ViewTimes";
	public final static String BUY_TIMES="BuyTimes";
	public final static String IS_SECKILL="IsSecondKill";
	public final static String LIMIT_TIME="LimitTime";
...
//    private Date AddDate;
	...
	public void printEntityShopCar() { 
